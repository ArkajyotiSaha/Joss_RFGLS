...
$$
where, $\mathbf Z$ is the membersip matrix for the leaf nodes, $(d^*,c^*)$ is optimal cut, with $d^*$ and $c^*$ being the optimal cut direction and cutoff point and $\hat{\boldsymbol{\beta}} $  denotes the node representatives of the leaf nodes. 
